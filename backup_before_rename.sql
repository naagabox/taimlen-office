...
--
-- Host: localhost    Database: timeline_proyek
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '0e49480a-ebbe-11f0-ad67-1bec4fc6f370:1-18';
...
CREATE TABLE `ActivityLog` (
  ...
  `taskTitle` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `oldStatus` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `newStatus` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `userId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `userName` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdAt` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `projectId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ActivityLog_projectId_fkey` (`projectId`),
...
CREATE TABLE `Task` (
  ...
  `status` enum('NOT_STARTED','IN_PROGRESS','FINISHED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NOT_STARTED',
...
-- Dump completed on 2026-05-14  7:19:30
